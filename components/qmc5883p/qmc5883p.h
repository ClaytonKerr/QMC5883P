...
enum QMC5883PRange {
  QMC5883P_RANGE_200_UT = 0b00,
  QMC5883P_RANGE_800_UT = 0b01,
};

enum QMC5883POversampling {
  QMC5883P_SAMPLING_512 = 0b00,
  QMC5883P_SAMPLING_256 = 0b01,
  QMC5883P_SAMPLING_128 = 0b10,
  QMC5883P_SAMPLING_64 = 0b11,
};
...
class QMC5883PComponent : public PollingComponent, public i2c::I2CDevice {
 ...
 protected:
  ...
  QMC5883PRange range_{QMC5883P_RANGE_200_UT};
  QMC5883POversampling oversampling_{QMC5883P_SAMPLING_512};
